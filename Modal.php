    ...
    <div class="nov" id="popup">
        ...
        <div class="container">
            <div class="logo-container">
                <img src="../image/7a.avif" alt="Logo" class="logo">
            </div>
            <h1>Modal Labs</h1>
            <p>Modal Labs lets you run data/AI jobs in the cloud by just writing a few lines of Python. Customers use Modal to deploy GenAI models at large scale, fine-tune LLM models, run protein folding simulations, and much more. Modal Labs uses Oracle's bare metal A10 instances because of the unbeatable combination of price and performance.</p>
