    ...
    <div class="page-background">
        ...
        <div class="blog-container">
            <div class="main-content">
                ...
                <p><a href="blog.php">Read the full article | Subscribe to the blog</a></p>
            </div>
            ...
            <div class="blog-sidebar">
                ...
                <div class="featured-blogs">
                    ...
                    <a href="Language.php">Announcing the general availability of OCI Language 3.0</a>

                    <p><strong>NOVEMBER 2, 2022</strong></p>
                    <a href="Language.php">Custom models and text translation come to OCI Language</a>

                    <p><strong>MARCH 11, 2021</strong></p>
                    <a href="Language.php">6 tips for easier AI adoption</a>
                </div>
            </div>
        </div>
    </div>
