    ...
    <section class="ai-quote-container">
        <div class="ai-quote-text">
            <p class="ai-quote-message">
                <span class="ai-quote-symbol">❝</span> Our real-time speech recognition feature helps ensure that your speech is accurately transcribed as you speak naturally, allowing for seamless and uninterrupted communication.
            </p>
            <p class="ai-quote-author">Greg Pavlik, SVP, Oracle Cloud Infrastructure</p>
            <button class="ai-quote-button">Read the blog post</button>
        </div>
