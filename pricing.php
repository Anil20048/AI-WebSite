...
@media screen and (max-width: 480px) {
    ...
    <div class="info-section">
        <h2>AI Cluster Information</h2>
        <p>
            Foundational models can be consumed on demand, where you pay per character based on the length of the prompt and the response from the model (except for the embedding models, where the response from the model isn’t accounted for). In the table below,
            a transaction = a character and 10,000 transactions = 10,000 characters.
        </p>
        <p>
            Additionally, you can host private replicas of foundational models and create fine-tuned models on dedicated AI clusters. Dedicated AI clusters come in two types: hosting and fine-tuning. You create a hosting cluster by assigning AI units to it based
            on the model you want to host and the expected call volume to the model. Fine-tuning clusters require two AI units of the specific model you want to fine-tune. Once you create a fine-tuned model in a fine-tuning cluster, you can host it on
            your hosting cluster.
        </p>
        <p>
    ...
    <div class="pricing-disclaimer-container">
        ...
        <div class="pricing-disclaimer">
            ...
            <p>To find out where a specific Oracle Cloud service is available refer to <a href="read1.php">Data Regions for Platform and Infrastructure Services</a>.</p>
            ...
            <p><em>Can you help us to improve? <a href="#">Leave feedback</a></em></p>
